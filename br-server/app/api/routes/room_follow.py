...
async def list_followed_rooms(
    ...
    return await room_follow_service.list_followed_rooms(db, user_id)
...
async def follow_room(
    ...
    try:
        room, created = await room_follow_service.follow_room(db, user_id, room_id)
    except ValueError:
...
async def unfollow_room(
    ...
    await room_follow_service.unfollow_room(db, user_id, room_id)
