...
## Corpus Check
- Large corpus: 1026 files · ~518,994 words. Semantic extraction will be expensive (many Claude tokens). Consider running on a subfolder, or use --no-semantic to run AST-only.

## Summary
- 5276 nodes · 11172 edges · 224 communities detected
- Extraction: 78% EXTRACTED · 22% INFERRED · 0% AMBIGUOUS · INFERRED: 2485 edges (avg confidence: 0.5)
- Token cost: 0 input · 0 output
- Edge kinds: contains: 2731 · uses: 2485 · ON_BRANCH: 1231 · MODIFIES: 1200 · calls: 993 · method: 680 · rationale_for: 574 · PARENT_OF: 359 · imports_from: 324 · inherits: 305 · imports: 283 · re_exports: 7
...
- Excluded: 5 untracked · 89017 ignored · 0 sensitive · 24 missing committed
- Recommendation: Use --scope all or graphify.yaml inputs.corpus for a knowledge-base folder.

## Graph Freshness
- Built from Git commit: `1017dbc`
...
Cohesion: 0.03
Nodes (89): dev, main, 020ddd3 debug: 延期功能前后端参数传递添加调试日志, 04745c9 chore: archive course-booking, 051c8b1 fix: 修复开课日期不显示和过期课时禁用逻辑 - 后端返回lesson_schedules数据, 0605022 fix: 课程编辑页与列表页在原 tab 内互相跳转，不再新开标签页, 0e90f58 fix: 排课更新后强制刷新列表数据, 0e940af feat(course): 所有课程页统一格式化上课时间并新增开课时间行 (+81 more)
...
Cohesion: 0.13
Nodes (33): admin_cancel_booking(), admin_get_booking(), admin_list_bookings(), BookingAlreadyCancelledError, BookingCancellationNotAllowedError, BookingConflictError, BookingCouponUnavailableError, BookingError (+25 more)
...
Cohesion: 0.11
Nodes (12): 02b3b93 feat: add course-detail page with all sections (7.1-7.8), 148395b feat(br-app): add course detail navigation from training list page, 3437127 test(task-6): 课程详情+关注完整测试，实现 list course follows, 38a606f chore: archive course-detail-page change, 7ff33ae Complete course-detail-page change, 84887cb fix: resolve Alembic migration revision ID conflict and fix inactive course test, a581dc1 feat: extend room_follow with follow_type for course follows, c2f96bd fix: add course_lessons table to migration & align frontend field names (+4 more)
...
Cohesion: 0.12
Nodes (9): 45e5bef feat: extend Course and Booking models for course booking, 85b99a1 feat: extend order list for course bookings and add course detail entry, ab174bc feat: add course booking API routes and extend booking list, b1018ae feat: add course booking page with full UI and payment flow, ca1b440 feat: add course booking schemas and service layer, e58bc04 feat: merge course-booking implementation into main, ea2d28b test: add course booking service and API tests, get_course_lessons() (+1 more)
...
Cohesion: 0.17
Nodes (14): 1017dbc revert: 回退后端list_bookings fallback条件改动，保留前端getLessonList处理, 3544ddd fix: 修复待开始订单课时列表不显示 - 添加lesson_schedules fallback逻辑, 3bd4e67 fix: 修复订单待开始状态显示和试听课时后端免费计费, 4ffdfd4 fix: 修复待开始订单课时列表fallback条件 - 仅保留list_bookings核心修复，回退前端改动, 7a0a320 tweak: 已取消订单隐藏去支付和取消按钮, 8021fb4 fix: 修复订单待开始Tab过滤和课时展开显示逻辑, abed773 chore: update br-admin logo image, remove backup, b97e6b2 feat: 订单列表待支付按钮 + 后端支付/取消API + Comet工作流配置 (+6 more)
...
## Knowledge Gaps
- **412 isolated node(s):** `Base exception for booking operations.`, `Create a booking with conflict detection.      Note: For MVP, conflict detection`, `List bookings for the current user with pagination.`, `Get a booking detail. Only own bookings are visible.`, `Cancel own paid future booking and refund the remaining amount to wallet.` (+407 more)
...
- **Thin community `Booking Service Tests`** (1 nodes): `TestCreateBooking`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Data Model Tests`** (1 nodes): `TestCancelBooking`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Coupon Service Tests`** (2 nodes): `Integration tests for file upload API endpoints.`, `TestUploadAPI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Integration Tests`** (1 nodes): `AdminMenuService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Admin Coupon Tests`** (1 nodes): `TestAvailableCouponsForBooking`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Seat Management Tests`** (1 nodes): `routes`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `HTML Sanitizer`** (1 nodes): `AdminSettingService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Room & Seat Models`** (2 nodes): `_payload()`, `TestAdminCouponApi`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Auth & Login Tests`** (2 nodes): `HTMLParser`, `_RichTextSanitizer`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Miscellaneous Module`** (1 nodes): `AdminRoleService`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Deployment Config`** (1 nodes): `TestSeatAPI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Coupon Service Layer`** (1 nodes): `TestCalculateStreakDays`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Course Management`** (1 nodes): `TestGetSummary`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Activity Management`** (1 nodes): `TestListRecords`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Room & Seat Management`** (1 nodes): `TestCourseModel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Teacher Management`** (1 nodes): `seed_teacher_data()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 202`** (2 nodes): `Integration tests for city APIs.`, `TestCityAPI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 203`** (2 nodes): `Unit tests for the City model.`, `TestCityModel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 219`** (2 nodes): `StudyRoom.room_type 字段验证。`, `TestStudyRoomRoomType`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 220`** (1 nodes): `TestTeacherModel`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 226`** (2 nodes): `setLoading()`, `useAsync()`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 227`** (1 nodes): `key`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 228`** (1 nodes): `useCityStore`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 232`** (1 nodes): `create_users_table  Revision ID: 0a2b2652445d Revises:  Create Date: 2026-04-17`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 233`** (1 nodes): `create_users_table  Revision ID: 1dfa25667f22 Revises: 0a2b2652445d Create Date:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 234`** (1 nodes): `create_activities_table  Revision ID: ba64420678cf Revises: 1dfa25667f22 Create`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 235`** (1 nodes): `create_seats_and_bookings  Revision ID: de5e1f080747 Revises: ba64420678cf Creat`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 236`** (1 nodes): `update_users_table  Revision ID: f836feddafc6 Revises: 28a1f4af90df Create Date:`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 237`** (1 nodes): `add_cities_table_and_room_city_id  Revision ID: 7c9d2e4f6a1b Revises: f836feddaf`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 238`** (1 nodes): `add_wechat_payment_fields  Revision ID: a8c3f1b2d4e5 Revises: 7c9d2e4f6a1b Creat`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 239`** (1 nodes): `add_booking_payment_query_schedule  Revision ID: f6a1b2c3d4e5 Revises: e5f6a1b2c`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 240`** (1 nodes): `add_notification_tables  Revision ID: a7b8c9d0e1f2 Revises: f6a1b2c3d4e5 Create`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 241`** (1 nodes): `add booking cancellation audit fields  Revision ID: b8c9d0e1f2a3 Revises: a7b8c9`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 242`** (1 nodes): `add room follows  Revision ID: c9d0e1f2a3b4 Revises: b8c9d0e1f2a3 Create Date: 2`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 243`** (1 nodes): `add_activity_coupon_campaign  Revision ID: f1a2b3c4d5e6 Revises: d0e1f2a3b4c5 Cr`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 244`** (1 nodes): `create_schedule_HotCourseItem  Revision ID: fccf087f0f34 Revises: e3f4a5b6c7d8 C`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 245`** (1 nodes): `create_course_table  Revision ID: c84abd1322d4 Revises: c4d5e6f7a8b9 Create Date`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 246`** (1 nodes): `add teacher bio and student_count  Revision ID: e7f8a9b0c1d2 Revises: c84abd1322`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Thin community `Community 253`** (1 nodes): `Battery`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 254`** (2 nodes): `CourseResponse`, `将逗号分隔字符串解析为列表，None 或空字符串返回空列表`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 255`** (1 nodes): `TeacherDetailResponse`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 256`** (2 nodes): `appThemeList`, `setting`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 259`** (1 nodes): `TestStudyRoomAPI`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 264`** (1 nodes): `BasicProps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 266`** (1 nodes): `directive`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 267`** (1 nodes): `RoleEnum`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 273`** (1 nodes): `TeacherCourseItem`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 274`** (1 nodes): `animates`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 276`** (1 nodes): `DynamicProps`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 278`** (1 nodes): `params`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.

## Suggested Questions
_Questions this graph is uniquely positioned to answer:_

- **Why does `Settings` connect `Auth & Login Tests` to `Auth & Login Tests`, `Auth & Login Tests`, `Teacher Management Tests`, `Auth & WeChat Integration`, `Booking Payment Service`, `Booking Service Tests`, `Booking System Core`, `Data Models & Schemas`, `Deployment Config`, `User Profile Tests`, `SMS & Captcha Tests`, `Booking Service Tests`, `Booking Payment Tests`, `Admin Coupon Tests`, `Booking Service Tests`, `JWT Token Tests`, `Booking Payment Tests`, `Miscellaneous Module`, `Admin RBAC System`, `Miscellaneous Module`?**
  _High betweenness centrality (0.094) - this node is a cross-community bridge._
- **Why does `StudyRoom` connect `Booking Payment Tests` to `Booking System Core`, `Booking Cancellation Tests`, `Auth & Login Tests`, `Wallet Service Tests`, `Miscellaneous Module`, `Backend Service Layer`, `Booking Payment Tests`, `Room Management Tests`, `Teacher Management Tests`, `Room & Seat Management`, `Data Model Tests`, `Booking Service Tests`, `SMS & Captcha Tests`, `Booking Cancellation Tests`, `Teacher Management`, `Community 259`, `Deployment Config`, `Course Management`, `Activity Management`, `Admin Coupon Tests`, `Token Verification`, `Booking Cancellation Tests`, `Coupon Service Layer`, `Coupon System`, `Auth & Login Tests`, `Miscellaneous Module`, `Coupon Service Tests`?**
  _High betweenness centrality (0.083) - this node is a cross-community bridge._
- **Why does `Base` connect `Auth & Login Tests` to `Teacher Management`, `SMS & Captcha Tests`, `Auth & Login Tests`, `Room Management Tests`, `Booking Payment Tests`, `Course Management`, `Wallet Service Tests`, `Teacher Management Tests`, `Booking Cancellation Tests`, `Auth & Login Tests`, `Miscellaneous Module`, `Teacher & Course Models`, `Miscellaneous Module`, `Room & Seat Service`?**
...
- **Should `Booking Service Tests` be split into smaller, more focused modules?**
  _Cohesion score 0.03383991894630192 - nodes in this community are weakly interconnected._