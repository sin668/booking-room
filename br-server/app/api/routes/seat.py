...
from app.schemas.seat import SeatResponse, SeatStatsResponse, SeatWithAvailabilityResponse
...
async def get_seat_stats(
    ...
    try:
        return await seat_service.get_seat_stats(db, room_id, target_date, start_time, end_time)
    except ValueError:
