...
MENU_SEEDS = [
    ...
    MenuSeed("room.list", "menu", "学习室管理", "room:view", "list", "RoomList", "/room/list/index", None, "HomeOutlined", 41, parent="room"),
    MenuSeed("room.edit", "menu", "编辑学习室", "room:edit:view", "list/edit/:id?", "RoomEdit", "/room/list/edit", None, "HomeOutlined", 43, hidden=True, parent="room"),
    ...
    MenuSeed("activity.edit", "menu", "编辑活动", "activity:edit:view", "list/edit/:id?", "ActivityEdit", "/activity/list/edit", None, "GiftOutlined", 52, hidden=True, parent="activity"),
...
BUTTON_SEEDS = [
    ...
    ("room.list", "room:create", "学习室-新增"),
    ("room.list", "room:update", "学习室-编辑"),
    ("room.list", "room:delete", "学习室-删除"),
    ("room.list", "room:status", "学习室-状态"),
    ...
    ("coupon.list", "coupon:create", "卡券-新增"),
    ("coupon.list", "coupon:update", "卡券-编辑"),
    ("coupon.list", "coupon:delete", "卡券-删除"),
