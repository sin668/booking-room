## Purpose
Define backend WeChat Pay recharge order creation, order status query, payment notification handling, and payment configuration security for wallet recharge.
