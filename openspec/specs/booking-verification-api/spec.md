# booking-verification-api Specification

## Purpose

Define the booking verification HTTP API: issuing short-lived backend-signed verification tokens for a user's verifiable booking, inspecting tokens by authenticated staff or administrators, and confirming verification to mark a booking completed, including token validity and authorization rules.
## Requirements
