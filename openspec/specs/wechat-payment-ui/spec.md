## Purpose
Define mini program recharge page behavior for invoking WeChat Pay, confirming payment completion from backend order status, unsupported payment methods, and payment state management.
