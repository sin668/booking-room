...
class EduListing(Base):
    ...
    city_id: Mapped[int | None] = mapped_column(Integer, nullable=True, index=True, comment="城市ID")
    area: Mapped[str | None] = mapped_column(String(100), nullable=True, comment="服务区域（详细区域）")
